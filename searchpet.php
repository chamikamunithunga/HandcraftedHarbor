...
<div class="container">
    ...
    <form action="" method="GET">
        <div class="input-group mb-3">
            <input type="text" name="search" required value="<?php if(isset($_GET['search'])){echo $_GET['search']; } ?>" class="form-control" placeholder="Search Pets">
    ...
    <div class="product-display">
        <table class="product-display-table">
            ...
            if(isset($_GET['search']))
            {
                ...
                $query = "SELECT * FROM pets WHERE CONCAT(name) LIKE '%$filtervalues%' ";
                    ...
                    foreach($query_run as $items)
                    {
                        ...
                        <tr>
                            ...
                            <td><form action="" method="post">
                                    ...
                                    <button type="submit" name="see_more" class="add">See More</button>
                                </form></td>
                        </tr>
                        <?php
                    }
