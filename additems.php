...
if(isset($_POST['add_product'])){
    ...
    $insert_query = mysqli_query($conn, "INSERT INTO `items`(name, price, image) VALUES('$p_name', '$p_price', '$p_image')") or die('query failed');
...
if(isset($_POST['update_product'])){
    ...
    $update_query = mysqli_query($conn, "UPDATE `items` SET name = '$update_p_name', price = '$update_p_price', image = '$update_p_image' WHERE id = '$update_p_id'");
                ...
                while($row = mysqli_fetch_assoc($select_products)){
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="additems.php?edit=<?php echo $row['id']; ?>" class="option-btn"> <i class="fas fa-edit"></i> update </a>
                        </td>
                    </tr>
